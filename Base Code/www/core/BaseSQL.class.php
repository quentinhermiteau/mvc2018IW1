...
class BaseSQL
{
    ...
    public function __construct()
    {
        ...
        try {
            $this->pdo = new \PDO("$databaseDriver:host=$databaseHost;dbname=$databaseName", $databaseUsername, $databasePassword);
    ...
    public function getOneBy(array $where, Object $object = null): PDOStatement
    {
